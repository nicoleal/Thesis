...
public class DisjointSets
{
	...
	/**
	 * ONE-ARG CONSTRUCTOR for DisjointSets. Constructs an array of
	 ...
	 * 		on the way to finding the parent to the parent directly (id est, turning 
	 * 		each parent into its own "star graph" if drawn graphically. 
	 * 
	 * 
	...
	/**
	 * getSetsArray - standard getter for setsArray
	 * 
	...
	/**
	 * setSetsArray - standard getter for setsArray
	 * 
	 * @param the disjoint set object
	 */
	public void setSetsArray(int[] array)
	{
		setsArray = array;
	}
	 ...
	 * 		input (set2) the child of the first input (set1). Done without regard
	 * 		for path length as path compression should reduce all paths to length
	 * 		one following call to findParent().
	 * 
